...
# Default path to the planet DEM PMTiles file (~657 GB, stays external).
DEFAULT_DEM_PATH = Path("/mnt/nas/nav/planet-dem.pmtiles")


def dem_path():
    """planet-DEM PMTiles path, env-overridable via NAVI_DEM_PMTILES."""
    return Path(os.environ.get('NAVI_DEM_PMTILES', str(DEFAULT_DEM_PATH)))
